...
TH2D* h2d = new TH2D("h2d", ";Momentum of the Lepton (Gev/c);Reconstructed Momentum of the JetGev/c)", 300, 0 , 0, 300, 0 , 0);
TH1F* histo = new TH1F("Histo","Standart Diviatiom;(Ev-(E_jet+E_l-0.938*(nfp+nfn)))/Ev;",100,-0.4,0.4 );
...
for(int ientry = 0; i >= ientry ; ++ientry){
    ...
    */
    ...
    histo -> Fill((Ev-(E_jet+E_l-0.938*(nfp+nfn)))/Ev);
